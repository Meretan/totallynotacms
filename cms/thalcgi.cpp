...
//
// NOTE there are exactly 4 possibilities to complete the work:
//   send_error_page, send_nocookie_page, send_the_page and send_result_page
//
                                       ...
                                       SessionData &sess, PathData &page)
{
    ...
    int cap_res = captcha_validate(form_ip, form_time, form_token, response);
                                ...
                                SessionData &sess, PathData &page)
{
    ...
    ScriptVariable code;
    int cr = sess.EmailChangeRequest(newemail, code);
...
static void captcha_setup(ThalassaCgiDb &db)
{
